...
This is a simple set up for Next-Firebase-Typescript for client side applications.

This is a project modified from https://github.com/vercel/next.js/tree/canary/examples/with-firebase, while extending the functionality for api to use next-connect
